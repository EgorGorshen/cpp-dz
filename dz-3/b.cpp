...
//
//     Пустые клетки содержат число ki,jki,j​ от 0 до 8 – количество
//     мин на соседних клетках. Соседними клетками являются восемь клеток,
//     имеющих смежный угол или сторону.
//
// Формат ввода
//
